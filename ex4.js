...
xhr.open("GET", apiUrl); // GET 방식으로 요청
xhr.onload = function () {
  if (xhr.status === 200) {
    ...
    const images = {
      a: "a.png", // lunAge가 1~6.9인 경우 보여줄 이미지
      b: "b.png", // lunAge가 7~14.9인 경우 보여줄 이미지
      c: "c.png", // lunAge가 15~21.9인 경우 보여줄 이미지
      d: "d.png", // lunAge가 0~0.9인 경우 보여줄 이미지
    };
