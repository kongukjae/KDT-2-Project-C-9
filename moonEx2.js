...
/*
const apiKey =
  "sLG8GxH%2BnJvDMU0R5HXBeGf0uKnmavrshGmvC%2F6x9JHxF1aAqG2gImPUoAnS0HcwF3u9y7VvXKUm%2B1skVniFcQ%3D%3D"; // 키값
const apiUrl = `http://apis.data.go.kr/B090041/openapi/service/LunPhInfoService/getLunPhInfo?serviceKey=${apiKey}&solYear=${currentYear}&solMonth=${currentMonth}&solDay=${currentDay}&_type=json`; */
//fix
//일단 불러왔어. lunAge를. 기존에 있던 월령 api관련된 것 없애자.
...
xhr.onload = function () {
  if (xhr.status === 200) {
    ...
    // moonN.textContent = lunAge; //어디에 넣을지를

    // const data = JSON.parse(xhr.responseText);
    // const lunAge = parseFloat(data.lunAge);
